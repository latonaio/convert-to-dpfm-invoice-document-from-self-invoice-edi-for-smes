...
import (
	...
	dpfm_api_output_formatter "convert-to-dpfm-invoice-document-from-self-invoice-edi-for-smes/DPFM_API_Output_Formatter"
	...
	"convert-to-dpfm-invoice-document-from-self-invoice-edi-for-smes/config"
	"fmt"
	"time"
